...
/* USER CODE BEGIN PV */
uint8_t rx_data[10]; // Variable to store the received byte
/* USER CODE END PV */
...
void setServoAngle(int angle1,int angle2,int angle3) {
   int minPulseWidth = 1000.0; // 1ms pulse width at a 1MHz clock
   int maxPulseWidth = 5000.0; // 2ms pulse width
